  ...
  <div class="renewal" v-loading="loading">
    <el-row>
      <el-col :span="6" class="left-container">
        ...
        <el-input v-model="uid" placeholder="点击手动输入会员ID" style="width: 240px">
          <el-button slot="append" @click="getRenewalTimeGift">查询</el-button>
        </el-input>
      </el-col>
      <el-col :span="16" style="border-left: 1px solid #eeeeee">
        ...
        <h4 style="color: #494949">
          续期费金额:<span style="color: red; font-weight: bold; font-size: 26px">￥{{ currentPkg.price | MIXIN_Points2Yuan }}元</span>
        </h4>
        <h4 style="color: #494949">当前有效截止日期：{{ currentPkg.endTime }}</h4>
        <h4 style="color: #494949">续期有效截止日期：{{ currentPkg.newEndTime }}</h4>
        <el-button type="primary" style="width: 128px" :disabled="!currentPkg.id" @click="handlePlaceOrder"> 确定 </el-button>
      </el-col>
    </el-row>
    <el-dialog
