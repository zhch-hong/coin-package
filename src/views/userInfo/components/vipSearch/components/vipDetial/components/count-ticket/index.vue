<template>
    <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="useNum" label="剩余次数" />
        <el-table-column prop="date" label="首次使用时间">
...
export default {
    ...
    methods: {
        async getData() {
            const res = await this.$api.getUserAllTimeNumGift({ uid: this.userInfo.uid, giftType: 3 })
