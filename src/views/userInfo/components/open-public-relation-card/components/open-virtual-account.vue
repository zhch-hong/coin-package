<template>
  <div class="open-virtual-account" v-loading="loading">
    <img style="width: 222px" src="@/assets/open-public-relation-card/virtual-account-img.png" alt="img" />
    <el-input-number style="display: block; margin-top: 32px" v-model="accountsCount" size="large" :min="1" :max="20" step-strictly></el-input-number>
    <el-button type="primary" style="padding: 12px 40px; margin-top: 32px" @click="handleConfirmOpenCard">确定</el-button>
    ...
    >
      <div class="dialog-header flex-between">
        ...
        <i class="el-icon-close" style="color: red; font-size: 24px; font-weight: bold; cursor: pointer" @click="closeSuccessDialog"></i>
      </div>
      <div class="dialog-body">
        ...
        <div class="actions flex-center" style="margin-top: 40px">
          <el-button type="primary" style="width: 128px" @click="handleSaveCard2Local">保存卡号</el-button>
          <el-button plain style="margin-left: 48px; width: 128px" @click="closeSuccessDialog">完成</el-button>
        </div>
      </div>
    </el-dialog>
  </div>
