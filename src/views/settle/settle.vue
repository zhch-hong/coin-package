    ...
    <vcard padding v-loading="loading">
      <el-form style="width: 100%" :inline="true" :model="searchForm">
        ...
        <el-row class="btn-box-padding">
          <el-col :span="24">
            <el-button :loading="loading" type="primary" size="mini" style="width: 96px" @click="handleOnOpenAuthModal('exportXlSX')"
              >导 出
            </el-button>
            <el-button :loading="loading" type="info" size="mini" style="width: 96px" @click="handleOnOpenAuthModal('printTicket')">打 印 </el-button>
            <el-button
              :loading="loading"
...
export default {
  ...
  methods: {
    ...
    async printTicket() {
      ...
      LODOP.ADD_PRINT_TEXT(425, 0, 180, 25, `技术支持：百川之星科技有限公司`)
      LODOP.PRINT()
    }
  },
  created() {
